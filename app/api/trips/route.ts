    ...
    try {
      ...
      const trips: Trip[] = (dbTrips || []).map(dbTrip => {
        ...
        return {
          ...
          // Vendor fields from dedicated columns (fallback to custom_fields for backwards compatibility)
          Flight_Vendor: dbTrip.flight_vendor || dbTrip.custom_fields?.flight_vendor,
          Hotel_Vendor: dbTrip.hotel_vendor || dbTrip.custom_fields?.hotel_vendor,
          Ground_Transport_Vendor: dbTrip.ground_transport_vendor || dbTrip.custom_fields?.ground_transport_vendor,
          Activities_Vendor: dbTrip.activities_vendor || dbTrip.custom_fields?.activities_vendor,
          Cruise_Operator: dbTrip.cruise_operator || dbTrip.custom_fields?.cruise_operator,
          Insurance_Vendor: dbTrip.insurance_vendor || dbTrip.custom_fields?.insurance_vendor,
          // Premium features
